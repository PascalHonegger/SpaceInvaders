...
* ViewModel
** Im ViwModel ist die *DestroyEverything* Methode getestet. Hinter diesem unscheinbaren Namen verbirgt sich die Logik, um die Variablen zurückzusetzen. Dies wird beispielsweise beim beenden des Spiels aufgerufen, damit ein neues Spiel gestartet werden kann.
** IsOutOfBounds
** FireShot
